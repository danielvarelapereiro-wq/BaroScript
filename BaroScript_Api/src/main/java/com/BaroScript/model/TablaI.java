...
public class TablaI {
    ...
    private Integer tabla1Id;

    @Column(name = "profundidad", nullable = false, precision = 3, scale = 1)
    private BigDecimal profundidad;

    @Column(name = "tiempo_limite_sin_deco")
    private Integer tiempeLimiteSinDeco;

    @Column(name = "es_ilimitado")
    ...
    public Integer getTabla1Id() { return tabla1Id; }
    public void setTabla1Id(Integer tabla1Id) { this.tabla1Id = tabla1Id; }
    ...
    public Integer getTiempeLimiteSinDeco() { return tiempeLimiteSinDeco; }
    public void setTiempeLimiteSinDeco(Integer tiempeLimiteSinDeco) { this.tiempeLimiteSinDeco = tiempeLimiteSinDeco; }

    public Boolean getEsIlimitado() { return esIlimitado; }
    public void setEsIlimitado(Boolean esIlimitado) { this.esIlimitado = esIlimitado; }
    ...
    public String toString() {
        return "TablaI{" +
                ...
                ", tiempeLimiteSinDeco=" + tiempeLimiteSinDeco +
